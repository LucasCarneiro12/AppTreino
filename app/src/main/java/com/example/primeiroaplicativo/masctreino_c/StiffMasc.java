...
public class StiffMasc extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_stiff_masc);
    ...
    public void abrirProximo(View view){
        Intent it_tela = new Intent(this, PanturrilhaSentadomasc.class);
        startActivity(it_tela);}
}