...
public class LegpressMasc extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_legpress_masc);

        ImageView legpress = findViewById(R.id.gif_legpress);
        Glide.with(this).asGif().load(R.drawable.legpress).into(legpress);
    ...
    public void abrirProximo(View view){
        Intent it_tela = new Intent(this, CadeiraExtensoramasc.class);
        startActivity(it_tela);}
}