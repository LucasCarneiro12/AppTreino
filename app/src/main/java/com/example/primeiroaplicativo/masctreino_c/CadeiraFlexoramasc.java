...
public class CadeiraFlexoramasc extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_cadeira_flexoramasc);
    ...
    public void abrirProximo(View view){
        Intent it_tela = new Intent(this, MesaFlexoramasc.class);
        startActivity(it_tela);}
}